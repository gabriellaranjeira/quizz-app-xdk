			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="addCur.php">
						<button type="submit" class="btn btn-primary">Dar Curso</button> 
						</form>
						<form action="excCur.php">
						<button type="submit" class="btn btn-primary">Retirar Curso</button> 
						</form>
