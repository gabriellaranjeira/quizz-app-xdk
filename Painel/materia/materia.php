			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Curso</h2>
					</div>
					<div class="box-content">
						<form action="addMat.php">
						<button type="submit" class="btn btn-primary">Criar nova matéria</button> 
						</form>
						<form action="editMat.php">
						<button type="submit" class="btn btn-primary">Editar materias</button> 
						</form>
						<form action="excluirMat.php">
						<button type="submit" class="btn btn-primary">Excluir materias</button> 
						</form>
