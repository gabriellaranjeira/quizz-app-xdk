			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<button type="submit" class="btn btn-primary">Criar novo curso</button> 
						</form>
						<form action="editCurso.php">
						<button type="submit" class="btn btn-primary">Editar cursos</button> 
						</form>
						<form action="excluirCurso.php">
						<button type="submit" class="btn btn-primary">Excluir cursos</button> 
						</form>
