...
if(isset($_POST['acao']) && $_POST['acao'] == "inserir"){
	...
	$curso = $conn->prepare('INSERT INTO curso(nome,
														descricao) VALUES (:nome,
														:descricao)');
	$curso->bindParam(':nome', $nome);
	$curso->bindParam(':descricao', $desc);
	if($curso->execute()){
		header('location:home.php?msg=Curso cadastrado com sucesso!');
	}else{
		header('location:home.php?msg=Não foi possivel cadastrar o curso!');
						...
						<form action="" method="post" class="form-horizontal">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Nome do curso: </label>
							  <div class="controls">
