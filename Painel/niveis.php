			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form actoin="criar_nivel.php">
						<button type="submit" class="btn btn-primary">Criar novo nivel</button> 
						</form>
						<form actoin="editar_nivel.php">
						<button type="submit" class="btn btn-primary">Editar niveis</button> 
						</form>
