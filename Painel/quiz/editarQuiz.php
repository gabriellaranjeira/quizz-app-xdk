...
if(!isset($_SESSION['user'])){
	...
	$consulta = $conn->prepare("SELECT * FROM quiz");
	$consulta->execute();	
}
?>
<!DOCTYPE html>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon edit"></i><span class="break"></span>Quiz</h2>
					</div>
					<div class="box-content">
						<form action="editarFunc.php" method="post" class="form-horizontal">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Quiz: </label>
							  <div class="controls">
								<select name="id">
							...
							<input type="hidden" name="edit" value="224">
							  <button type="submit" class="btn btn-primary">Editar quiz</button>
