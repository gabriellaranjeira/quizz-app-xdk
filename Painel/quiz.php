			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form actoin="criar.php">
						<button type="submit" class="btn btn-primary">Criar novo quiz</button> 
						</form>
						<form actoin="excluir_quiz.php">
						<button type="submit" class="btn btn-primary">Excluir quiz</button> 
						</form>
